    ...
    <div className="flex min-h-screen mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col items-start pl-10">
              ...
              <img
                ...
                alt="Insurance"
                className="h-44 w-80 object-cover border-2 rounded-lg border-gray-300 cursor-pointer"
                onClick={() =>
                  openImageModal(`${backendUrl}${driver.insurance}`)
                }
              />
            </div>
            ...
            <div className="flex flex-col items-start pl-10">
              ...
              <img
                ...
                alt="Rc Document"
                className="h-44 w-80 object-cover rounded-lg border-2 border-gray-300 cursor-pointer"
      ...
      >
        ...
        Back
            ...
            <div className="flex space-x-2 w-full pl-44">
        <button
