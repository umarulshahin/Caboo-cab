  ...
  return (
    <div className="flex flex-col h-screen mx-auto bg-[url('https://w0.peakpx.com/wallpaper/580/650/HD-wallpaper-whatsapp-bg-dark-background-thumbnail.jpg')] p-4 rounded-md">
      <div
        ...
        className="chat_ui flex-1 overflow-y-auto mb-4 max-h-[calc(100vh-100px)] scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent hover:scrollbar-thumb-gray-300"
      >
